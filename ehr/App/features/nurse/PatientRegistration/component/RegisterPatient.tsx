                ...
                <View style={styles.inputGroup}>
                  ...
                  <TextInput
                    ...
                    onChangeText={v => {
                      ...
                      if (formErrors.other_religion) setFormErrors({ ...formErrors, other_religion: '' });
                    }}
                  />
                  {formErrors.other_religion ? <Text style={styles.errorTextSmall}>{formErrors.other_religion}</Text> : null}
                </View>
              )}
                ...
                <View style={styles.inputGroup}>
                  ...
                  <TextInput
                    ...
                    onChangeText={v => {
                      ...
                      if (formErrors.other_ethnicity) setFormErrors({ ...formErrors, other_ethnicity: '' });
                    }}
                  />
                  {formErrors.other_ethnicity ? <Text style={styles.errorTextSmall}>{formErrors.other_ethnicity}</Text> : null}
                </View>
              )}
