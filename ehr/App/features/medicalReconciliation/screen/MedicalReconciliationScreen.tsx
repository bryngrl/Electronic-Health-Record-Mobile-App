    ...
    <SafeAreaView style={styles.root}>
      ...
      >
        ...
        <TouchableOpacity 
          style={[
            styles.actionBtn, 
            (!isDataEntered || isSubmitting || !patientId) && styles.btnDisabled
          ]} 
          onPress={handleNext}
          ...
          {isSubmitting ? (
            ...
            <>
              <Text 
                style={[
                  styles.btnText,
                  (!isDataEntered || isSubmitting || !patientId) && { color: '#9E9E9E' }
                ]}
              >
...
const styles = StyleSheet.create({
  ...
  actionBtn: { backgroundColor: '#DCFCE7', height: 50, borderRadius: 25, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 10, borderWidth: 1, borderColor: '#035022' },
  btnDisabled: { backgroundColor: '#F0F0F0', borderColor: '#E0E0E0', opacity: 0.6 },
